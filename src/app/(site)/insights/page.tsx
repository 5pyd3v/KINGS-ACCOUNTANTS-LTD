            ...
            {caseStudies.map((caseStudy, index) => (
              <Reveal key={caseStudy.slug} delay={index * 0.07}>
                <Link
                  ...
                  className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-ink-100 bg-paper-dim/60 transition-colors duration-500 hover:border-brand-200"
                >
